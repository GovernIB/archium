...
public class ProcedimentController implements Serializable {
	...
	@Inject
	private ProcedimentServices 			serviceProcediment;	    
	...
	public ProcedimentServices getServiceProcediment() {
		return serviceProcediment;
	}

	public void setServiceProcediment(ProcedimentServices serviceProcediment) {
