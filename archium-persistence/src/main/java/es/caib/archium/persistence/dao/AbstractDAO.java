package es.caib.archium.persistence.dao;

import es.caib.archium.commons.i18n.I18NArgumentString;
 ...
 * @author anadal
 */
// @RolesAllowed(Constants.ACH_ADMIN)
// en desarrollo mas adelante se integrara con keylock
@PermitAll
    ...
    protected Predicate getFilterPredicate(Root<E> root, Map<String, Object> filters) {
        ...
        for (String attributeName : filters.keySet()) {
            ...
            if (bindableJavaType.equals(String.class)) {
            	...
            	predicateList.add(cb.isNull(attributePath));
            } else {
