...
import es.caib.archium.services.NuevaSerieService;
...
public class NuevaSerieController implements Serializable {
	...
	@Inject
	private NuevaSerieService service;
	...
	public NuevaSerieService getService() {
		return service;
	}

	public void setService(NuevaSerieService service) {
